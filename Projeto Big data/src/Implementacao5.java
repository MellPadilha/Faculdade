...
public class Implementacao5 {
    public static class MapperImplementacao5 extends org.apache.hadoop.mapreduce.Mapper<Object, Text, Text, IntWritable> {

        @Override
        public void map(Object key, Text valor, Context context) throws IOException, InterruptedException {
            String linha = valor.toString();
            String[] campos = linha.split(";");
            if(campos.length == 9 && campos[4].equals("MOTOR VEHICLE THEFT")){
                String ano = campos[2];
                int ocorrencia = 1;
    ...
    public static class ReducerImplementacao5 extends org.apache.hadoop.mapreduce.Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
      ...
      job.setJarByClass(Implementacao5.class);
